function ProgressBar() {
    ...
    // figure out how to center this
       <div class="flex border-t border-white/10 px-4 py-3">
            ...
            <a href="#" class="relative inline-flex items-center rounded-md border border-leaves bg-leaves px-4 py-2 text-sm font-medium text-gray-200 hover:bg-white/10">Previous</a>
            ...
            <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <nav aria-label="Pagination" class="isolate inline-flex -space-x-px rounded-md">
                    ...
                    <a href="#" aria-current="page" class="relative z-10 inline-flex items-center bg-stone px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone">1</a>
                    <a href="#" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-200 inset-ring inset-ring-gray-700 hover:bg-nature focus:z-20 focus:outline-offset-0">2</a>
